...
[![✅ Checks](https://github.com/libhal/navigator/actions/workflows/ci.yml/badge.svg)](https://github.com/libhal/navigator/actions/workflows/ci.yml)
[![Coverage](https://libhal.github.io/navigator/coverage/coverage.svg)](https://libhal.github.io/navigator/coverage/)
[![GitHub stars](https://img.shields.io/github/stars/libhal/navigator.svg)](https://github.com/libhal/navigator/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/libhal/navigator.svg)](https://github.com/libhal/navigator/network)
[![GitHub issues](https://img.shields.io/github/issues/libhal/navigator.svg)](https://github.com/libhal/navigator/issues)

libhal compatible device library for the navigator device.
...
The navigator repository is a template for creating device libraries in
...
- `applications/navigator.cpp`: A sample application demonstrating usage of the
  device library.
...
includes `navigator.hpp`, which is a placeholder for the main header file of
your device library.

## src

This directory contains the source files for the device library. It currently
includes `navigator.cpp`, which is a placeholder for the main source file of
your device library.
...
- `navigator.test.cpp`: A placeholder for tests for the device library.
- `main.test.cpp`: The main entry point for the tests.

Remember to replace all instances of `navigator` with the actual name of the
